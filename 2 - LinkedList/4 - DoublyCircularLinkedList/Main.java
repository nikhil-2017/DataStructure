...
public class Main {
        ...
        while (!quit) {
            ...
            switch (action) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    System.out.print("Deleted Number : ");
    ...
    public static void displayOption() {
        String[] options = {"Display Option", "InsertAtEnd", "DeleteAtEnd", "Delete Number", "show", "size", "headElement", "tailElement", "lastNodeNext", "headNodePrev", "Search Number", "Quit"};
